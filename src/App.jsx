  ...
  return (
    <div>
      ...
      <div style={{background:'#F7F2EC', padding:'14px 16px'}}>
        ...
        <div style={{background:'#fff', borderRadius:'18px', border:'1.5px solid #FFE5D0', overflow:'hidden', marginBottom:'10px'}}>
    ...
    <div>
      <div style={{background:'#FF6B35', padding:'10px 16px 24px'}}>
        <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'16px'}}>
          ...
          <div onClick={async () => { await supabase.auth.signOut(); setUser(null) }} style={{background:'rgba(255,255,255,0.25)', borderRadius:'20px', padding:'5px 12px', fontSize:'12px', fontWeight:'700', color:'#fff', cursor:'pointer'}}>
  Déconnexion
</div>
        </div>
...
function EcranMesRepas({ setEcran }) {
  ...
  return (
    <div>
      ...
      <div style={{padding:'14px 16px'}}>
        <div style={{background:'#FF6B35', borderRadius:'16px', padding:'12px 16px', display:'flex', alignItems:'center', gap:'10px', marginBottom:'16px'}}>
